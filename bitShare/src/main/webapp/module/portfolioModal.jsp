...
<div class="slide modal" id="modalView" tabindex="-1" role="dialog"
			...
			<div class="modal-body1" vertical-align="middle">
					...
					<div class="cycle-slideshow" data-cycle-fx="scrollHorz"
						...
						<img src="img/portfolio/cabin.png"
							...
							class="img-responsive" /> <img src="img/portfolio/cake.png"
							style="width: auto; height: auto;"
							class="img-responsive" /> <img src="img/portfolio/circus.png"
							style="width: auto; height: auto;"
							class="img-responsive" /> <img src="img/portfolio/game.png"
							style="width: auto; height: auto;"
							class="img-responsive" /> <img src="img/portfolio/safe.png"
							style="width: auto9; height: auto;"
							class="img-responsive" /> <img src="img/portfolio/submarine.png"
							style="width: auto; height: auto;"
  ...
  <div class='inner'>
    ...
    <label for="your-Email" style="font-size: 20px;">Email</label><br/>
      <input class='input your-Email' placeholder='Type your Email here...' type='text'><br/><br/>
      <textarea class='input your-msg' placeholder='Type your message here...' type='text'></textarea>
			...
			<div align="center">
				<div class="modal-body">
					...
					<button type="button" class="btn btn-default"
						style="text-size: 20px" data-dismiss="modal">ok!</button>
					<br />
					<br />
					<br />
				</div>
