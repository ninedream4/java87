					...
					<form name="addUserform" method="post" action="/user/addUser">
						...
						<div class="form-group" style="width: 70%; margin: auto;">
							<label for="inputConfirmPassowrd" style="font-size: 20px;">Password
								...
								id="inputConfirmPassowrd" name="pwd2"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form name="updateUserform" method="post" action="/user/updateUser">
						...
						<br />
						<div class="form-group" style="width: 70%; margin: auto;">
							<label for="inputPassword" style="font-size: 20px;">Password
								Update</label> <input type="password" class="form-control"
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary"
						onclick="updateUsersubmit()">Submit</button>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form name="logoutform" method="post" action="/user/logout">
						로그아웃 하시겠 습니까(뺄생각임)</form>
					<br />
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-primary"
						onclick="logoutUsersubmit()">Log out</button>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					...
					<div class="dropdown-content" style="position: relative;">
						<a href="category.html">java</a> 
						<a href="category.html">c/c++</a>
				...
				<li class="dropdown">
					...
					<div class="dropdown-content" style="position: relative;">
						<a data-toggle="modal" data-target="#mypage">정보 수정</a> <a
							data-toggle="modal" data-target="#mypage">게시물 수정</a>
				</li>

				<li><a data-toggle="modal" data-target="#logout" style="cursor:pointer">logout</a></li>
		</div>
		</li>
	...
	<div class="container" style="background-color: black;">
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<form name="searchform" method="post" action="/user/listContent">
					<div id="search">
						<input id="search" placeholder="Search"
							value="${! empty search.searchKeyword ? search.searchKeyword : " "}"  />
						<button id="searchButton" onclick="searchsubmit()">
