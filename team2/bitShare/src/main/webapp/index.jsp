		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form id="addUserform" name="addUserform" method="post" action="/user/addUser">
						<div class="form-group" style="width: 70%; margin: auto;">
							<label for="inputEmail" style="font-size: 20px;">Email
...
<script src="js/vaildationCheck.js" ></script>
	...
	<script type="js/fileUploadButton.js" ></script>
	<script src="js/userSubmit.js"  id="addUser"></script>
  <script type="text/javascript" src="js/validationCheck.js"></script>
</body>
</html>