...
<script type="text/javascript">
	...
	function addContentsubmit() {
		/* var title=document.addContentform.title.value;
		  var upload=document.addContentform.filePath.value;
		  var description=document.addContentform.fileDesc.value;
		  vat tag=document.addContentform.tag.value;
		  
		  if(title == null || title.length <1){
		    alert("제목을 반드시 입력하셔야 합니다.");
		    return;
		  }
